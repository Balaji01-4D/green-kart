...
const (
	ProductPlannedStatus   = "planned"
	ProductGrowingStatus   = "growing"
...
type CatalogProduct struct {
	...
	ShopProducts []FarmerProduct `gorm:"foreignKey:CatalogID" json:"shop_products"`
}
...
type FarmerProduct struct {
	...
	Status    string `gorm:"type:varchar(50);not null;default:'for_sale'" json:"status"`
	...
	Units      string  `gorm:"type:varchar(50);not null" json:"units"`
	CreatedAt time.Time `gorm:"autoCreateTime" json:"created_at"`
	UpdatedAt time.Time `gorm:"autoUpdateTime" json:"updated_at"`

	Shop           Farmer         `gorm:"foreignKey:ShopID" json:"shop"`
